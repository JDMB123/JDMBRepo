...
(This will be slightly different if you have [switched to Postgres][postgres].)
...
setup the gems Guard and Spring to make your TDD flow a lot smoother. Accessing this on GitHub? Use [this link][github-guard-spring-setup].

[guard-spring-setup]: spring-and-guard-setup
[github-guard-spring-setup]: https://github.com/appacademy/curriculum/blob/master/rails/readings/guard-spring-setup.md
