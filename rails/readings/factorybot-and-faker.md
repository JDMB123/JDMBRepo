...
* [Set up RSpec][rspec-setup] for your Rails application. Accessing this on GitHub? Use [this link][github-rspec-setup]
* In the `Gemfile`, add `gem 'factory_bot_rails'` under `group
...
[rspec-setup]: rspec-and-rails-setup
[github-rspec-setup]: https://github.com/appacademy/curriculum/blob/master/rails/readings/rspec-and-rails-setup.md
