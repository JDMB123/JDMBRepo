...
* Create `BandsController` and actions/views to handle each of the routes
  ...
  * Test as you go! Remember, we can use [Postman][postman-reading] to test `POST`, `PATCH` and `DELETE` actions prior to building our form views. Accessing this on GitHub? Use [this link][github-postman-reading].
...
[postman-reading]: testing-routes-with-postman
[github-postman-reading]: https://github.com/appacademy/curriculum/blob/master/rails/readings/postman.md
...
* **This is the first time that we'll be using nested routes in a project. Please make sure your routes for albums exactly match the ones below. Check out [this reading][routing-ii] that you may have missed if the motivation and syntax for creating nested routes is still unclear. Accessing this on GitHub? Use [this link][github-routing-ii]. Don't hesitate to ask a TA for assistance!**
...
* On signup, send the user an email (via
  [ActionMailer][mailer-reading]). Accessing this on GitHub? Use [this link][github-mailer-reading]. 
...
[routing-ii]: routing-ii--nested-collections
[github-routing-ii]: https://github.com/appacademy/curriculum/blob/master/rails/readings/routing-part-ii.md
