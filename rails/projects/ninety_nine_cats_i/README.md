...
First, follow the setup instructions in [Rails setup][rails-setup]! Accessing this on GitHub? Use [this link][github-rails-setup]. 
...
[github-rails-setup]: https://github.com/appacademy/curriculum/blob/master/rails/readings/rails-setup.md
...
* Timestamps
* Add database-level NOT NULL constraints and model-level presence [validations][validations]. Accessing this on GitHub? Use [this link][github-validations].
...
[validations]: displaying-validation-errors--flash
[github-validations]: https://github.com/appacademy/curriculum/tree/master/rails/readings/validation.md
...
* First, write a method `#overlapping_requests` to get all the
  ...
  * Beware of [SQL ternary logic][sql-ternary-logic]. Accessing this on GitHub? Use [this link][github-sql-ternary-logic].
...
[sql-ternary-logic]: ternary-logic-in-sql
[github-sql-ternary-logic]: https://github.com/appacademy/curriculum/blob/master/sql/readings/sql-ternary-logic.md
...
* You may add two [member][member-routes] routes to `cat_rental_requests`: `approve`
  and `deny`. Accessing this on GitHub? Use [this link][github-member-routes].
* Only show these buttons if a request is pending.
* You may want to add a convenient `CatRentalRequest#pending?`
  method.

[member-routes]: routing-iii--adding-non-default-routes
[github-member-routes]: https://github.com/appacademy/curriculum/blob/master/rails/readings/routing-part-iii.md
