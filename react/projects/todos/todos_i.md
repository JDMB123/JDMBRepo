...
* Set up your `webpack.config.js` file so that your bundle.js is saved in the root directory of your project. If you need to remind yourself how to set up the file look [here][webpack-setup].  Accessing this on GitHub? Use [this link][github-webpack-setup].
* Start `webpack --watch`
...
[webpack-setup]: webpack
[github-webpack-setup]: https://github.com/appacademy/curriculum/tree/master/react/readings/webpack_configuration.md
...
* Refer to the [store reading][store-reading] if needed.  Accessing this on GitHub? Use [this link][github-store-reading].
...
our components to use. That's where selectors come in! [Selectors][selector-reading]
are "getter" methods for the application state. Accessing this on GitHub? Use [this link][github-selector-reading].
...
Refer to the `Component` and `Connect` readings if you need a refresher on container components.
...
* Create a new component (`components/todo_list/todo_form.jsx`).
  * This component will use controlled inputs to keep track of its form data; thus it will have a local state
    * If you don't remember how to set up controlled inputs in a React component, look at this reading about [props and state][props-and-state-reading].  Accessing this on GitHub? Use [this link][github-props-and-state-reading].
...
[store-reading]: store
[github-store-reading]: https://github.com/appacademy/curriculum/blob/master/react/readings/store.md

[props-and-state-reading]: props-and-state
[github-props-and-state-reading]: https://github.com/appacademy/curriculum/blob/master/react/readings/props_and_state.md

[selector-reading]: selectors
[github-selector-reading]: https://github.com/appacademy/curriculum/blob/master/react/readings/selectors.md
