...
Style your app to look like the [live demo][live-demo]. Our HTML/CSS [curriculum][html-css-curriculum](Accessing this on GitHub? Use [this link][github-html-css-curriculum]), the [Complete Guide to Flexbox][flexbox-guide], and the internet are good resources if you get stuck! 🎨🖌

[html-css-curriculum]: css-review-video
[github-html-css-curriculum]: https://github.com/appacademy/curriculum/tree/master/html-css
...
We've supplied the CSS for a pokeball spinner that you can use (in `app/assets/loading-pokeball.scss`).
...
Once you are finished with Phase 10 head over to [part three][pokedex-part-three]. Accessing this on GitHub? Use [this link][github-pokedex-part-three].

[pokedex-part-three]: pokedex--part-3-
[github-pokedex-part-three]: https://github.com/appacademy/curriculum/blob/master/react/projects/pokedex/pokedex_iii.md
