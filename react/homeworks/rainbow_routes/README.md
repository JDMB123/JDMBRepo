...
the [reading][intro] for details.  Accessing this on GitHub? Use [this link][github-intro].) Add the necessary `Route` components
...
[intro]: intro-to-react-router
[github-intro]: https://github.com/appacademy/curriculum/blob/master/react/readings/intro_to_react_router.md
