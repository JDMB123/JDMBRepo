...
As you saw in the [Redux store][store] (Accessing this on GitHub? Use [this link][github-store]) reading, the `store` has a **reducer**
...
And here's an example of a good one which uses lodash's merge function to create a deep dup of the previous `state`:
...
Note the use of [`Object.freeze()`][object-freeze]. Accessing this on GitHub? Use [this link][github-object-freeze]. Even though `fruitReducer` doesn't mutate the state, `Object.freeze()` will ensure that state can't be accidentally mutated. Get in the habit of using `Object.freeze` at the top of every reducer you write!  

[object-freeze]: object-freeze
[github-object-freeze]: https://github.com/appacademy/curriculum/blob/master/react/readings/object_freeze.md
