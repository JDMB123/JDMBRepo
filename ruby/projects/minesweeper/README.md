...
Reference [the readings on serialization][serialization]. Accessing this on GitHub? Use [this link][github-serialization].
...
0. push your code
  ...
  **NB:** If you want the commits to be under your name as opposed to
  ...
  before each push. Accessing this on GitHub? Use [this link][github-git-authorship-script].
...
See [here][overriding-inspect] for more info if you need a refresher on how to do this. Accessing this on GitHub? Use [this link][github-overriding-inspect].
...
[github-serialization]: https://github.com/appacademy/curriculum/blob/master/ruby/readings/serialization.md
...
[git-authorship-script]: fixing-git-commit-authorship
[github-git-authorship-script]: https://github.com/appacademy/curriculum/blob/master/ruby/readings/git-fix-authorship.md
