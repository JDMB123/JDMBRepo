...
# class. You'll see that we're creating a new spec for 'Integer' --
...
#     \["inspect", "%", "<<", ...
#
# The number 4 is of class `Integer` and it has methods on it.  Your
# challenge is to add an `in_words` method to `Integer`.
