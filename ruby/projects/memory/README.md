...
Common problem: Having issues with `#hide` and `#reveal`? Try [testing
small][testing-small]. Accessing this on GitHub? Use [this
link][github-testing-small].

[testing-small]: testing-small--from-memory-puzzle-
[github-testing-small]: https://github.com/appacademy/curriculum/blob/master/ruby/readings/testing-small.md
