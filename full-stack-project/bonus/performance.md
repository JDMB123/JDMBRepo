...
* [Caching in Rails][rails-caching] - Accessing this on GitHub? Use [this link][github-rails-caching].
* [Caching with Redis in Rails][redis-caching] - Accessing this on GitHub? Use [this link][github-redis-caching].
* [Caching railscasts][railscasts-caching]

[rails-caching]: caching-in-rails
[github-rails-caching]: https://github.com/appacademy/curriculum/blob/master/full-stack-project/resources/caching/caching.md
[redis-caching]: caching-with-redis-in-rails
[github-redis-caching]: https://github.com/appacademy/curriculum/blob/master/full-stack-project/resources/caching/redis.md
