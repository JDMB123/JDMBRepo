...
[mail-skeleton]: https://assets.aaonline.io/fullstack/javascript/projects/mail/skeleton.zip
...
* `renderMessage`
  ...
  * Using a [template literal][template-literals] will make this easier by letting
    you interpolate as you would with an `html.erb` file. Accessing this on GitHub? Use [this link][github-template-literals]
...
[github-template-literals]: https://github.com/appacademy/curriculum/blob/master/javascript/readings/template-literals.md
