...
We're going to take our first steps using CSS! In this assignment we'll build a pixel perfect clone of [this page][live-04]. Download the skeleton [here][css-skeleton]!
...
* [margin][margin] and padding - Accessing this on GitHub? Use [this link][github-margin].
* [border][p-border] (and border-bottom, border-left, etc.)
* [width][width] - Accessing this on GitHub? Use [this link][github-width].
* [font-family][p-font-family]
* [font-size][p-font-size]
* [font-weight][p-font-weight]
* [color][p-color]
* [background][p-background]
* [float][float] - Accessing this on GitHub? Use [this link][github-float].
...
[margin]: css-margin
[github-margin]: https://github.com/appacademy/css-demos#margin
[display]: css-display
[github-display]: https://github.com/appacademy/css-demos#the-display-property
[width]: css-intro
[github-width]: https://github.com/appacademy/css-demos#rectangles
[float]: css-float
[github-float]: https://github.com/appacademy/css-demos#floats
...
[shots]: http://assets.aaonline.io/fullstack/html-css/projects/css_review/screenshots.zip
[inspector]: http://assets.aaonline.io/fullstack/html-css/projects/css_review/dev_tools_chrome.png
